...
<?php
		...
		$crime_name = filter_input(INPUT_GET,'crimename');
		
		
		


		$sql = "INSERT INTO crime_record (crime_id, crime_name ) 
		VALUES ('$crime_id', '$crime_name')";


if ($conn->query($sql) === TRUE) {
    //echo "New record created successfully";
	echo "<div id='card'><p>Crime Record Successfully Added</p><form action='add_crime_record.php' method='get'><button type='submit' id='done'>Done</button></form></div>";
