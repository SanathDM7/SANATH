        ...
        <div class="cont">
            ...
            <ul>
                <li id="titlehead" style="text-decoration: underline;text-decoration-color:black;">
                    <p id="title" style="font-size:30px;"><a href="officer_home.php">USER HOME</a></p>
                </li>
			...
			<div ><button type="button" class="btn" onclick="location.href='Cell_search.php'">Cell Record</button></div>
-->
